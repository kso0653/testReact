...
export default {
    ...
    getToken: function (data, callback) {
        ...
        let url = globals.wehagoCommonApiUrl + '/thirdparty/request-token';
        ajax.post(url, {service_code: service_code}).then(function(response) {
    ...
    call: function(url, method, options, args) {
        ...
        try {
            ...
            //return new Promise(function (resolve, reject) {
                ...
                let service_code = target.getServiceCode();
                if ($.cookie(service_code + "_token") == undefined){
        ...
        */
        ...
        $.ajax({
            ...
            success: function (data, textStatus) {
                ...
                console.log(CryptoJS.enc.Base64.stringify(hashText));
